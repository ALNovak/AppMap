...
(function () {
    ...
    var MarkerClusterer =
        ...
        BMapLib.MarkerClusterer = function (map, options) {
           ...
           // this._map.addEventListener("click", function () {
                //that._redraw();         
            //});
    ...
    MarkerClusterer.prototype.Gf = function () {
        var count = 0;
        for (var i = 0, cluster; cluster = this._clusters[i]; i++) {
            //cluster.isReal() && count++;
            return cluster;
    ...
    Cluster.prototype.updateClusterMarker = function () {
       ...
       // this._clusterMarker.setText(this._markers);

        var thatMap = this._map;
       
        var thatBounds = this.getBounds();     
        this._clusterMarker.addEventListener("click", function (e) {           
            // thatMap.setViewport(thatBounds); 
            TransferMap.Map.ClickEventsOverlay(e);
            //TransferMap.ClickEventsOverlay(e);
        });   
    };
